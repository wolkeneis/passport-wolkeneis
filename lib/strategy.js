 ...
 * @property {string} [authorizationURL="https://moos.wolkeneis.dev/oauth2/authorize"]
 * @property {string} [tokenURL="https://moos.wolkeneis.dev/oauth2/token"]
...
function Strategy(options, verify) {
  ...
  options.authorizationURL =
    options.authorizationURL || "https://moos.wolkeneis.dev/oauth2/authorize";
  options.tokenURL =
    options.tokenURL || "https://moos.wolkeneis.dev/oauth2/token";
  options.scopeSeparator = options.scopeSeparator || " ";

  OAuth2Strategy.call(this, options, verify);
  this.name = "wolkeneis";
  this._userProfileURL =
    options.userProfileURL || "https://moos.wolkeneis.dev/api/v1/application/profile";
}
...
Strategy.prototype.userProfile = function (accessToken, done) {
  this._oauth2.get(this._userProfileURL, accessToken, function (error, body) {
    if (error) {
      return done(
        new InternalOAuthError("Failed to fetch the user profile.", error)
      );
    }
